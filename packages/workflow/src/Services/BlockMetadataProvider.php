    ...
    private function getBlockRules(): array
    {
        return [
            'trigger' => [
                'maxOutgoing' => 1,
                'maxIncoming' => 0,
                'allowedTargets' => ['action', 'condition', 'filter', 'switch', 'delay', 'loop'],
                'allowedSources' => [],
                'isTerminal' => false,
                'isRoot' => true,
                'edgeLabels' => [],
            ...
            'action' => [
                'maxOutgoing' => 1,
                'maxIncoming' => null,
                'allowedTargets' => ['action', 'condition', 'filter', 'switch', 'delay', 'loop', 'stop'],
                'allowedSources' => ['trigger', 'action', 'condition', 'filter', 'switch', 'delay', 'loop'],
                'isTerminal' => false,
                'isRoot' => false,
                'edgeLabels' => [],
            ],
            'condition' => [
                ...
                'maxIncoming' => null,
                'allowedTargets' => ['action', 'condition', 'filter', 'switch', 'delay', 'loop', 'stop'],
                'allowedSources' => ['trigger', 'action', 'filter', 'switch', 'delay', 'loop'],
                'isTerminal' => false,
                'isRoot' => false,
                'edgeLabels' => ['Yes', 'No'],
            ],
            ...
            'delay' => [
                'maxOutgoing' => 1,
                'maxIncoming' => null,
                'allowedTargets' => ['action', 'condition', 'filter', 'switch', 'loop', 'stop'],
                'allowedSources' => ['trigger', 'action', 'condition', 'filter', 'switch', 'delay', 'loop'],
                'isTerminal' => false,
                'isRoot' => false,
                'edgeLabels' => [],
            ...
            'loop' => [
                'maxOutgoing' => 1,
                'maxIncoming' => null,
                'allowedTargets' => ['action', 'condition', 'filter', 'switch', 'delay', 'stop'],
                'allowedSources' => ['trigger', 'action', 'condition', 'filter', 'switch', 'delay', 'loop'],
                'isTerminal' => false,
                'isRoot' => false,
                'edgeLabels' => [],
            ...
            'stop' => [
                ...
                'maxIncoming' => null,
                'allowedTargets' => [],
                'allowedSources' => ['action', 'condition', 'filter', 'switch', 'delay', 'loop'],
                'isTerminal' => true,
                'isRoot' => false,
                'edgeLabels' => [],
            ],
