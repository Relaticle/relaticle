...
final class RelationshipBuilder
{
     ...
     * @param mixed $foreignKey Not used for this relationship type
     */
    protected function buildBelongsToMany(
        string $sourceType,
        string $targetType,
        array $relationships,
        $foreignKey = null
     ...
     */
    protected function buildBelongsTo(
        string $sourceType,
        string $targetType,
        array $relationships,
        ?string $foreignKey = null
    ): void {
        $foreignKey = $foreignKey ?? "{$targetType}_id";
     ...
     * @param string $targetType Target entity type
     * @param array<string, array<string>> $relationships Map of source keys to target keys
     * @param mixed $foreignKey Not used directly, derived from sourceType
     */
    protected function buildHasMany(
        string $sourceType,
        string $targetType,
        array $relationships,
        $foreignKey = null
