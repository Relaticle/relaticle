...
<header
                ...
                <a href="{{ url('/') }}" class="flex items-center space-x-2.5 group" aria-label="Relaticle Home">
                    <div class="relative overflow-hidden">
                        <img class="h-8 w-auto transition-transform duration-300 group-hover:scale-105"
                             src="{{ asset('relaticle-logo.svg') }}" alt="Relaticle Logo">
                    </div>
                    <span
    ...
    <div id="mobile-menu-backdrop"
         class="hidden fixed inset-0 bg-black/20 dark:bg-black/40 backdrop-blur-sm z-40 transition-opacity duration-300 opacity-0 md:hidden"></div>
    <div id="mobile-menu"
        ...
        <div class="p-6 flex flex-col h-full">
            ...
            <div class="mb-2">
                <span
                    class="text-xs font-medium uppercase tracking-wider text-gray-400 dark:text-gray-500">Navigation</span>
            </div>
            ...
            <nav class="flex-grow space-y-1 mb-8">
                <a href="#features"
                   ...
                   style="transition-delay: 100ms;">
                    <x-heroicon-o-squares-2x2
                        class="mr-3 h-5 w-5 {{ request()->is('/') || request()->is('/#features') ? 'text-primary dark:text-primary-400' : '' }}"/>
                ...
                <a href="{{ route('documentation.index') }}"
                   ...
                   style="transition-delay: 150ms;">
                    <x-heroicon-o-document-text
                        class="mr-3 h-5 w-5 {{ Route::is('documentation.*') ? 'text-primary dark:text-primary-400' : '' }}"/>
                ...
                <a href="https://github.com/Relaticle/relaticle" target="_blank" rel="noopener"
                   ...
                   style="transition-delay: 200ms;">
                    <x-icon-github class="mr-3 h-5 w-5"/>
                    <span class="font-medium">GitHub</span>
                    @if(isset($githubStars) && $githubStars > 0)
                        <span
                            class="ml-1.5 text-xs bg-gray-100 dark:bg-gray-800 text-gray-700 dark:text-gray-300 px-1.5 py-0.5 rounded-full flex items-center">
                            <span>{{ $formattedGithubStars }}</span>
                        </span>
                    @endif
            ...
            <div class="mb-2">
                <span
                    class="text-xs font-medium uppercase tracking-wider text-gray-400 dark:text-gray-500">Account</span>
            </div>
            ...
            <div class="space-y-1 mb-8">
                <a href="{{ route('login') }}"
                   ...
                   style="transition-delay: 250ms;">
                    ...
                    @if(Route::is('login'))
                        <span
                            class="ml-auto bg-primary/10 dark:bg-primary/20 text-primary dark:text-primary-400 text-xs font-medium px-2 py-0.5 rounded-full">Active</span>
                    @endif
                </a>
            ...
            <div
                ...
                <button
                    ...
                    <div class="relative">
                        <div
                            class="w-10 h-5 bg-gray-200 dark:bg-gray-700 rounded-full shadow-inner transition-colors duration-200"></div>
                        <div
                            class="dot absolute left-0 top-0 bg-white dark:bg-primary w-5 h-5 rounded-full shadow transform dark:translate-x-5 transition-transform duration-200"></div>
                    </div>
                </button>
            </div>
