<x-guest-layout title="{{ __('Join :team', ['team' => $team->name]) }}">
    <div class="flex min-h-[60vh] items-center justify-center">
        <div class="mx-auto max-w-md px-6 py-12 text-center">
            <h1 class="text-2xl font-bold text-gray-900 dark:text-white">
                {{ __('Join :team', ['team' => $team->name]) }}
            </h1>

            <p class="mt-4 text-gray-600 dark:text-gray-400">
                {{ __('You have been invited to join the :team team. Confirm to accept the invitation.', ['team' => $team->name]) }}
            </p>
