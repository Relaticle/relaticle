<div id="mcp-chat" class="bg-white dark:bg-neutral-950 flex flex-col min-h-[300px] sm:min-h-[400px] md:min-h-[500px]">
    ...
    <div class="flex-1 p-4 sm:p-6 md:px-8 md:py-6 space-y-5">
        ...
        {{-- User 1 --}}
        <div class="mcp-msg flex items-start gap-2.5">
        ...
        <div class="mcp-msg flex items-start gap-2.5">
            ...
            <div class="flex-1 min-w-0">
                <div class="text-sm text-gray-600 dark:text-gray-300 leading-relaxed mb-2.5">Done. Created the contact and linked her to Acme Corp.</div>
                <div class="bg-gray-50 dark:bg-white/[0.03] rounded-lg p-3 border border-gray-200/80 dark:border-white/[0.06]">
        ...
        <div class="mcp-msg flex items-start gap-2.5">
            ...
            <div class="flex-1 min-w-0">
                <div class="text-sm text-gray-600 dark:text-gray-300 leading-relaxed mb-2.5">Found <span class="font-medium text-gray-900 dark:text-white">3 deals</span> worth $245K total.</div>
                <div class="space-y-1.5">
                    @foreach([
                        ...
                        <div class="flex items-center justify-between bg-gray-50 dark:bg-white/[0.03] rounded-lg px-3 py-2.5 border border-gray-200/80 dark:border-white/[0.06]">
                            <div>
    ...
    {{-- Input bar --}}
    <div class="mcp-msg border-t border-gray-100 dark:border-white/[0.06] px-4 sm:px-6 md:px-8 py-3">
