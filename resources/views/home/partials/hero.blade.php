...
<section class="relative py-20 md:py-28 lg:py-36 bg-white dark:bg-black overflow-hidden">
    <!-- Extremely subtle animated grid pattern overlay -->
    <div class="absolute inset-0 bg-grid-pattern opacity-[0.015] dark:opacity-[0.025]"></div>
    ...
    <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        <div class="space-y-12 md:space-y-14">
            <!-- Tech Stack Badge - Refined -->
            <div class="flex justify-center">
                <div class="inline-flex items-center space-x-4 px-3 py-1.5 border border-gray-100 dark:border-gray-800 rounded-full text-sm shadow-sm">
                    <span class="text-gray-500 dark:text-gray-400 text-xs">Built with</span>
            ...
            <div class="flex flex-col sm:flex-row justify-center items-center gap-5">
                <a href="{{ route('register') }}" class="group w-full sm:w-auto inline-flex items-center justify-center gap-2 bg-black hover:bg-gray-900 dark:bg-white dark:hover:bg-gray-50 text-white dark:text-black px-7 py-3.5 rounded-md text-base font-medium transition-all duration-200 shadow-sm hover:shadow relative overflow-hidden">
            ...
            <div class="mt-16 md:mt-20 max-w-5xl mx-auto">
                <div class="bg-white dark:bg-gray-900 rounded-lg overflow-hidden border border-gray-100 dark:border-gray-800 shadow-lg dark:shadow-gray-950/20 transform transition-transform duration-700 hover:scale-[1.01]">
                    <!-- Browser Header -->
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-6 mt-14 md:mt-20 border-t border-gray-100 dark:border-gray-800 pt-12 px-2">
                <div class="p-4 text-center">
                    <div class="text-lg md:text-xl font-bold text-black dark:text-white">Open Source</div>
                    <div class="text-sm text-gray-500 dark:text-gray-400 mt-1.5">Free to use and customize</div>
                </div>
                <div class="p-4 text-center">
                    <div class="text-lg md:text-xl font-bold text-black dark:text-white">Modern Stack</div>
                    <div class="text-sm text-gray-500 dark:text-gray-400 mt-1.5">PHP 8.3, Laravel 12</div>
                </div>
                <div class="p-4 text-center">
                    <div class="text-lg md:text-xl font-bold text-black dark:text-white">Secure</div>
                    <div class="text-sm text-gray-500 dark:text-gray-400 mt-1.5">Enterprise-grade security</div>
                </div>
                <div class="p-4 text-center">
                    <div class="text-lg md:text-xl font-bold text-black dark:text-white">Scalable</div>
                    <div class="text-sm text-gray-500 dark:text-gray-400 mt-1.5">Grows with your business</div>
                </div>
            </div>
        </div>
    </div>
