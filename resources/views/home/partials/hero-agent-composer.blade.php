...
<div class="mcp-el mcp-input border-t border-gray-100 dark:border-white/[0.06] px-4 sm:px-6 md:px-8 py-3">
    <div class="flex items-center gap-3 bg-gray-50/80 dark:bg-white/[0.03] rounded-xl border border-gray-200/80 dark:border-white/[0.06] focus-within:border-primary/40 dark:focus-within:border-primary/40 px-3.5 py-2.5">
        ...
        <div class="flex items-center gap-1.5">
            <button type="button" tabindex="-1" class="inline-flex items-center gap-1 rounded-md border border-gray-200 dark:border-white/[0.08] bg-white dark:bg-white/[0.03] px-2 py-1 text-[10px] font-medium text-gray-600 dark:text-gray-300">
                <span>Auto</span>
