...
<div class="flex items-start gap-2.5">
    ...
    <div class="flex-1 min-w-0">
        ...
        <div class="space-y-2.5">
            <div class="mcp-el mcp-tool mcp-tool-1 flex items-center gap-2 text-micro sm:text-xs">
            ...
            <div class="mcp-el mcp-action-card rounded-lg border border-amber-200/80 dark:border-amber-500/30 bg-amber-50/60 dark:bg-amber-500/[0.06] overflow-hidden" aria-hidden="true">
                ...
                <div class="px-3 pb-3">
                    ...
                    <div class="mt-3 flex items-center gap-2">
                        <button type="button" tabindex="-1" class="inline-flex items-center gap-1.5 rounded-md bg-gray-900 dark:bg-white px-3 py-1.5 text-micro font-medium text-white dark:text-gray-900 hover:bg-gray-800 dark:hover:bg-gray-100 transition-colors">
                            <x-ri-check-line class="w-3 h-3"/>
                            Approve
                        </button>
                        <button type="button" tabindex="-1" class="inline-flex items-center gap-1.5 rounded-md border border-[var(--surface-input-border)] bg-[var(--surface-input-bg)] px-3 py-1.5 text-micro font-medium text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-white/[0.06] transition-colors">
...
<div class="mcp-el mcp-user mcp-user-3 flex items-start gap-2.5">
    ...
    <div class="flex-1 min-w-0">
        <div class="text-xs font-semibold text-gray-900 dark:text-white mb-1">You</div>
        <div class="text-sm text-gray-900 dark:text-gray-100 leading-relaxed">
            Add Sarah Chen as a contact at <span class="inline-flex items-center gap-1 rounded-md bg-primary/10 dark:bg-primary/20 px-1.5 py-0.5 text-xs font-medium text-primary-700 dark:text-primary-300 align-baseline">@Kovra Systems</span>. She's VP of Engineering.
        </div>
    </div>
</div>
...
<div class="flex items-start gap-2.5">
    ...
    <div class="flex-1 min-w-0">
        ...
        <div class="space-y-2.5">
            <div class="mcp-el mcp-tool mcp-tool-3 flex items-center gap-2 text-micro sm:text-xs">
                <span class="inline-flex items-center gap-1.5 text-primary dark:text-primary-300 font-medium">
                    <x-ri-loader-4-line class="w-3 h-3 shrink-0"/>
