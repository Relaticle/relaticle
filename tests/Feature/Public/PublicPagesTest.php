...
describe('Legal pages', function (): void {
    it('displays the terms of service page with product-specific content', function (): void {
    ...
    it('displays the privacy policy page with product-specific content', function (): void {
...
describe('Documentation pages', function (): void {
    ...
    it('displays the getting started guide', function (): void {
    ...
    it('displays the import guide', function (): void {
    ...
    it('displays the developer guide', function (): void {
    ...
    it('displays the self-hosting guide', function (): void {
    ...
    it('displays the MCP guide', function (): void {
    ...
    it('shows edit on GitHub link on documentation pages', function (): void {
        $response = $this->get('/docs/getting-started');
    ...
    it('can search documentation and returns results', function (): void {
...
describe('Pricing page', function (): void {
    it('displays the pricing page', function (): void {
...
describe('Authentication redirects', function (): void {
    it('redirects login to app panel', function (): void {
        $response = $this->get('/login');

        $response->assertRedirect(url()->getAppUrl('login'));
    });

    it('redirects register to app panel', function (): void {
        $response = $this->get('/register');

        $response->assertRedirect(url()->getAppUrl('register'));
    });

    it('redirects forgot password to app panel', function (): void {
        $response = $this->get('/forgot-password');

        $response->assertRedirect(url()->getAppUrl('forgot-password'));
    });

    it('redirects dashboard to app panel', function (): void {
