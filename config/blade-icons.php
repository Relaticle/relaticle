...
return [
    ...
    */
    ...
    'sets' => [
        ...
        // Phosphor icons (all weights in single directory with prefix in filename)
        // Usage: phosphor-o-house, phosphor-b-house, phosphor-d-house, phosphor-f-house
        'phosphor' => [
            'path' => 'resources/svg/phosphor/icons',
            'prefix' => 'phosphor',
            'fallback' => '',
            'class' => '',
            'attributes' => [],
